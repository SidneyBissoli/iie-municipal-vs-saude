...
# with reading-list metadata and the `notes/` folder. Updates the auto-block
# in `bibliography/README.md`.
...
#' user populates it), and checks whether a per-note file exists in `notes/`.
#'
