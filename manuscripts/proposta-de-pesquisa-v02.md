...
regressão *two-way Mundlak* (TWM) estendida — formalmente equivalente, sob condições especificadas em Wooldridge (2025), ao 
TWFE com indicadores de coorte e interações com covariáveis tempo-variantes 
— implementada via Poisson de pseudo-máxima verossimilhança com efeitos fixos, mediante inclusão 
manual de médias intra-UF e intra-coorte do IIE como controles. A regressão 
Mundlak estendida é reportada como sensibilidade central na §4.3, na mesma 
tabela do TWFE Poisson principal.
